...
TASKS = [
    ...
    (
        ...
        [
            ...
            "  - Data is written to Programs\\Data\\",
            "",
    ...
    (
        ...
        [
            ...
            "Every correct choice is reinforced.",
            "",
            "Before starting:",
            "  - MED-PC.exe must be running",
            "  - In MPCLoader, run the loader macro and click S;1",
            "  - Prime and count the hopper (protocol 9.2)",
            "",
            "Pellets are COMMANDED, not verified - this feeder has no",
            "sensor. Count the receptacle at the end of the session.",
            "Data is written to Programs\\Data\\",
        ],
    ),
]
